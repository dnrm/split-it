...
const Prism: React.FC<PrismProps> = ({
  ...
  useEffect(() => {
    ...
    if (!container) {
      console.log('Prism: Container not found');
      return;
    }

    console.log('Prism: Initializing WebGL context');
    ...
    try {
      ...
      gl = renderer.gl;
      console.log('Prism: WebGL context created successfully');
    } catch (error) {
      console.error('Prism: Failed to create WebGL context:', error);
      return;
    }
    ...
    console.log('Prism: Canvas appended to container');
